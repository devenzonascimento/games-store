    ...
    <main className="mb-16 flex-1 flex flex-col items-center justify-start gap-6 py-6 px-4 bg-zinc-900 overflow-y-auto">
      ...
      <div className="flex flex-col items-center gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-base font-semibold italic text-white">4,5</span>
        </div>
      </div>
      ...
      <div className="w-full flex flex-col items-center gap-4">
        <button
          type="button"
          className="w-full p-3 flex items-center justify-center gap-2 text-lg font-medium text-white bg-emerald-800 rounded-lg"
        >
        ...
        <button
          type="button"
          className="w-full p-3 flex items-center justify-center gap-2 text-lg font-medium text-zinc-950 bg-white rounded-lg"
        >
